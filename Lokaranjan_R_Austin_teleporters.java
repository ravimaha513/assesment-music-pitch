...
public class Solution {
  public static void main(String[] argv) {
    List<String> teleporters1 = Arrays.asList("3,1", "4,2", "5,10");
    List<String> teleporters2 = Arrays.asList("5,10", "6,22", "39,40", "40,49", "47,29");
    List<String> teleporters3 = Arrays.asList("6,18", "36,26", "41,21", "49,55", "54,52",
                            "71,58", "74,77", "78,76", "80,73", "92,85");
    List<String> teleporters4 = Arrays.asList("97,93", "99,81", "36,33", "92,59", "17,3",
  ...
  public static List<Integer> destinations(List<String> teleporters, int die, int start, int end){
    Set<Integer> possibleDestinations = new HashSet<>();
      for (int dieRoll = 0; dieRoll <= die; dieRoll++) {
          int newSquare = start + dieRoll;
          if (newSquare < teleporters.size() && newSquare >= 0) {
            String teleporter = teleporters.get(newSquare);
              int destination = Integer.parseInt(teleporter.split(",")[1]);
              if(newSquare ==1) {
