...
public class Solution {
    public static void main(String[] args) {
        ...
        String[] song4 = {"B4", "E4", "G4", "G4", "A4", "B4", "E4", "B4", "E4", "G4", "G4", "A4", "C5", "B4", "E5", "G4",
                "G4", "A4", "B4", "C5", "D5", "C5", "B4", "C5", "E5", "D5", "C5", "C5", "B4", "B4", "E5", "E4", "G4", "G4",
                "A4", "B4", "B4", "B4", "C5", "E5", "A5", "E5", "C5", "A4", "E5", "D5", "C5", "B4"};
        String[] song5 = {"F4"};
    ...
    public static boolean singable(String[] songs, String low, String high) {
        int from = getNoteOrder(low);
        int to = getNoteOrder(high);

        for (String song : songs) {
            int noteOrder = getNoteOrder(song);
            if (noteOrder < from || noteOrder > to) {
                return false;
            }
        }
    ...
    public static int getNoteOrder(String note) {
        char pitch = note.charAt(0);
        int octave = Integer.parseInt(note.substring(1));

        return octave * 7 + getPitchOrder(pitch);
    }

    public static int getPitchOrder(char pitch) {
        switch (pitch) {
            case 'C':
                return 0;
            case 'D':
